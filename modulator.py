...
class Modulator:
    ...
    def make_16psk_mod(self, bits):
        ...
        for i in range(0, len(signalBits)-1, 4):
            if signalBits[i] == 0 and signalBits[i + 1] == 0 and signalBits[i+2] == 0 and signalBits[i+3] == 0:  # theta1 case
                sinwave.extend(sinwave1)
            elif signalBits[i] == 0 and signalBits[i + 1] == 0 and signalBits[i+2] == 0 and signalBits[i+3] ==1 :  # theta2 case
                sinwave.extend(sinwave2)
            elif signalBits[i] == 0 and signalBits[i + 1] == 0 and signalBits[i+2] == 1 and signalBits[i+3] == 0 :  # theta3 case
                sinwave.extend(sinwave3)
            elif signalBits[i] == 0 and signalBits[i + 1] == 0 and signalBits[i+2] == 1 and signalBits[i+3] == 1 : # theta4 case
                sinwave.extend(sinwave4)
            elif signalBits[i] == 0 and signalBits[i + 1] == 1 and signalBits[i+2] == 0 and signalBits[i+3] == 0 :  # theta5 case
                sinwave.extend(sinwave5)
            elif signalBits[i] == 0 and signalBits[i + 1] == 1 and signalBits[i+2] == 0 and signalBits[i+3] == 1 :  # theta6 case
                sinwave.extend(sinwave6)
            elif signalBits[i] == 0 and signalBits[i + 1] == 1 and signalBits[i+2] == 1 and signalBits[i+3] == 0 :  # theta7 case
                sinwave.extend(sinwave7)
            elif signalBits[i] == 0 and signalBits[i + 1] == 1 and signalBits[i+2] == 1 and signalBits[i+3] == 1 :  # theta8 case
                sinwave.extend(sinwave8)
            elif signalBits[i] == 1 and signalBits[i + 1] == 0 and signalBits[i+2] == 0 and signalBits[i+3] == 0:  # theta9 case
                sinwave.extend(sinwave9)
            elif signalBits[i] == 1 and signalBits[i + 1] == 0 and signalBits[i+2] == 0 and signalBits[i+3] == 1:  # theta10 case
                sinwave.extend(sinwave10)
            elif signalBits[i] == 1 and signalBits[i + 1] == 0 and signalBits[i+2] == 1 and signalBits[i+3] == 0:  # theta11 case
                sinwave.extend(sinwave11)
            elif signalBits[i] == 1 and signalBits[i + 1] == 0 and signalBits[i+2] == 1 and signalBits[i+3] == 1:  # theta12 case
                sinwave.extend(sinwave12)
            elif signalBits[i] == 1 and signalBits[i + 1] == 1 and signalBits[i+2] == 0 and signalBits[i+3] == 0:  # theta13 case
                sinwave.extend(sinwave13)
            elif signalBits[i] == 1 and signalBits[i + 1] == 1 and signalBits[i+2] == 0 and signalBits[i+3] == 1:  # theta14 case
                sinwave.extend(sinwave14)
            elif signalBits[i] == 1 and signalBits[i + 1] == 1 and signalBits[i+2] == 1 and signalBits[i+3] == 0:  # theta15 case
                sinwave.extend(sinwave15)
            elif signalBits[i] == 1 and signalBits[i + 1] == 1 and signalBits[i+2] == 1 and signalBits[i+3] == 1:  # theta16 case
